...
const ProductItem = ({ item }) => {
    return (
        <motion.div
            ...
            >
                <div className="hover-element absolute top-0 left-0 w-0 h-0 rounded-full flex bg-white items-center justify-center transition-all duration-500 ease-in-out z-[1] group-hover:w-[70px] group-hover:h-[70px] group-hover:scale-[15]"></div>
